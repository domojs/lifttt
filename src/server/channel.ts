...
export var channel = new akala.Api()
    .clientToServerOneWay<{ name: string, fields: Field[] }>()({ registerTrigger: true, registerAction: true, registerCondition: true })
    .clientToServerOneWay<{ name: string }>()({ registerChannel: true })
